...
HD_PWD='D:/Users/Administrator/Desktop/lesson33.2/prj/prj.runs/clk_global_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_global.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_global.tcl
