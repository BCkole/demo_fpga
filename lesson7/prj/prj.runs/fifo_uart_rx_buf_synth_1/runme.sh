...
HD_PWD='D:/Users/Administrator/Desktop/lesson33.2/prj/prj.runs/fifo_uart_rx_buf_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_uart_rx_buf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_uart_rx_buf.tcl
