...
HD_PWD='D:/Users/Administrator/Desktop/FILE/lesson/Num0/lesson16/prj/prj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sg_ram_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sg_ram_test.tcl
