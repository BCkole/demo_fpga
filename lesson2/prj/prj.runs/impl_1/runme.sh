...
HD_PWD='D:/Users/Administrator/Desktop/FILE/lesson/Num0/lesson16/prj/prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sg_ram_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sg_ram_test.tcl -notrace
