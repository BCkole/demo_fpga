...
#
# Generated by export_simulation on Thu May 01 19:25:29 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './sg_ram.sh' script.
...
./sg_ram.sh -noclean_files

For more information on the script, please type './sg_ram.sh -help'.
