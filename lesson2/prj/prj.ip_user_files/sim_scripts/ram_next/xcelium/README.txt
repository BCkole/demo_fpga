...
#
# Generated by export_simulation on Tue Oct 28 09:27:12 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './ram_next.sh' script.

./ram_next.sh -reset_run
...
./ram_next.sh -noclean_files

For more information on the script, please type './ram_next.sh -help'.
