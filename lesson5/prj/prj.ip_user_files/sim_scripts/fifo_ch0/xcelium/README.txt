...
#
# Generated by export_simulation on Wed May 21 15:34:25 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './fifo_ch0.sh' script.

./fifo_ch0.sh -reset_run
...
./fifo_ch0.sh -noclean_files

For more information on the script, please type './fifo_ch0.sh -help'.
